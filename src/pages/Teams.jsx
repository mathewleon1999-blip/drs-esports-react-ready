...
const teams = [
  {
    ...
    members: [
      { 
        ...
        social: { twitter: "@shakkir", discord: "Shakkir#5678" }
      },
      { 
        name: "Dream", 
        role: "Fragger", 
      ...
      { 
        ...
        mainRole: "Support",
        joinDate: "2023-03-10",
        stats: { kda: "1.9", hs: "28%", matches: 138 },
        social: { twitter: "@shyno", discord: "Shyno#9012" }
      },
      { 
        name: "Xander", 
        role: "Sniper", 
        ...
        mainRole: "Sniper",
        joinDate: "2023-04-05",
        stats: { kda: "1.7", hs: "25%", matches: 125 },
        social: { twitter: "@xander", discord: "Xander#3456" }
      }
    ],
